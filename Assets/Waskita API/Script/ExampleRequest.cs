...
//{
//    public Button btnLogin, btnValidate, btnSaveJson, btnLoadJson, btnLearning, btnImage, btnOpenMaterial, btnCloseMaterial, btnNewProject, btnNextDay, btnPoints;
...
//        #region Button Auth
//        btnLogin.onClick.AddListener( delegate { Login(); });
...
//    /// <summary>
//    /// login request dengan parameter "username" "password" "deviceID" "clientID" dan "Gameversion"
//    /// akan return data player dan project yang sedang dikerjakan (jika ada)
//    /// selain itu request ini akan return token, dimana token akan digunakan pada setiap hit API
//    /// </summary>
//    /// <returns></returns>
//    public void Login()
//    {
...
//            Debug.Log(JsonUtility.ToJson(success));
//            if (success.responseMessage.responseCode == 1002)
//            {
...
//    public void HandleError(BasicResponse response)
//    {
//        Debug.Log(response.responseMessage.message);
//        Debug.Log(response.responseMessage.responseCode);
//    }
...
//            var utfbytes = Encoding.UTF8.GetBytes(utf);
//            Debug.Log(utf);
//            Debug.Log(bytes[0].ToString());
//            Debug.Log(utfbytes[0].ToString());
//            File.WriteAllBytes(Application.persistentDataPath + "/" + "utf8" + ".png", utfbytes);
